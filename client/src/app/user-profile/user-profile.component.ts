...
export class UserProfileComponent implements OnInit {
  ...
  baseRideUrl = 'https://scarlet-bass-hose.cyclic.app/api/v1/ride/rideByuser';
  baseBookedRideUrl =
    'https://scarlet-bass-hose.cyclic.app/api/v1/ride/bookedRideByuser';
  ...
  baseUrl =
    'https://scarlet-bass-hose.cyclic.app/api/v1/user/update-profilePicture';
  ...
  cancelRide(ride: any) {
    this.http
      .delete(
        `https://scarlet-bass-hose.cyclic.app/api/v1/ride/cancelRide/${ride._id}`
      )
